...
async def test_list_departments_returns_seven(client: AsyncClient, seeded_db):
    """DEPT-03: GET /api/departments returns all 7 departments without authentication."""
